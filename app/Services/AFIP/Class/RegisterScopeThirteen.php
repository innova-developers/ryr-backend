...
class RegisterScopeThirteen extends AfipWebService
{
    ...
    public $WSDL = 'ws_sr_padron_a13-production.wsdl';
    public $URL = 'https://aws.afip.gov.ar/sr-padron/webservices/personaServiceA13';
    public $WSDL_TEST = 'ws_sr_padron_a13.wsdl';
    public $URL_TEST = 'https://awshomo.afip.gov.ar/sr-padron/webservices/personaServiceA13';
